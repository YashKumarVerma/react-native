...
class JSI_EXPORT NativePlatformConstantsAndroidSpecJSI
    : public JavaTurboModule {
 public:
...
class JSI_EXPORT NativePushNotificationManagerIOSSpecJSI
    : public JavaTurboModule {
 public:
...
class JSI_EXPORT NativeTVNavigationEventEmitterSpecJSI
    : public JavaTurboModule {
 public:
